                            ...
                            <div class="col-lg-6">
                                <div class="p-lg-5 p-4">
                                    <div>
                                        ...
                                        <p class="text-muted">Faça login para continuar na Parrot.</p>
                                    </div>
                                    ...
                                    <div class="mt-4">
                                        <form action="{{ route('login_auth') }}" method="POST">
                                            ...
                                            <div class="mb-3">
                                                <div class="float-end">
                                                    <a href="auth-pass-reset-cover" class="text-muted">Esqueceu a senha?</a>
                                                </div>
                                            ...
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="auth-remember-check">Lembrar
                                                    me</label>
                                            </div>
